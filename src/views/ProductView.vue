...
const productForm = ref({
  ...
  unit: '',
  price: 0,
  purchaseDate: currentSimulatedDate.value, // NEW
})
...
const openAddDialog = () => {
  ...
  productForm.value = {
    ...
    unit: '',
    price: 0,
    purchaseDate: currentSimulatedDate.value, // Use current business date
  }
  dialog.value = true
}
    ...
    <v-container class="pa-4 pa-md-8">
        ...
        <v-row>
          <v-col cols="12" class="product-list-container pa-4 pa-md-8 rounded-xl">
            <v-card
              class="product-list-card pa-6 pa-md-10 rounded-xl"
              elevation="4"
              min-height="550"
            >
